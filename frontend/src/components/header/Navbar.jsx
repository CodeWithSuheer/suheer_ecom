...
const Navbar = () => {
    ...
    return (
        <>
            {user?.role !== 'admin' ? (
                <nav className={` bg-white shadow-lg transition-all ${isSticky ? 'fixed top-0 left-0 right-0 z-50' : 'relative'}`}>
                    <div className="container px-6 py-4 mx-auto">
                        <div className="lg:flex lg:items-center lg:justify-between">
                            ...
                            <div className="hidden lg:flex lg:items-center">
                                ...
                                <Link to="/" className="px-3 py-2 mx-3 text-gray-700 hover:bg-gray-100 rounded-xl">Contact</Link>
