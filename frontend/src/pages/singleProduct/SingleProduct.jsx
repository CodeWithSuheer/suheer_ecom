...
const SingleProduct = () => {
    ...
    return (
        <section className="overflow-hidden min-h-[100vh] flex justify-center items-center">
                ...
                <div className="mx-auto flex flex-wrap items-center lg:w-4/5">
                    ...
                    <div className="mt-6 w-full lg:mt-0 lg:w-1/2 lg:pl-10">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link to="/cart" className="rounded-md bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">
                                Add to Cart
                            </Link>
                        </div>
                    </div>
