...
const Testimonial = () => {
    ...
    const testimonialData = [
        {
            ...
            desc: "We provide you with a test account that can be set up in seconds. Our main focus is getting responses to you as soon as we can.",
            review: "Amazing people to work with. Very fast and professional service.",
            name: "Josh Grazioso",
            post: "Director Payments & Risk | Airbnb",
        },
        {
            id: 2,
            title: "It's all about speed",
    ...
    return (
        <>
            <section key="1" className="container px-4 py-10 sm:px-6 lg:px-8 lg:pt-14 lg:pb-20 mx-auto">
                <div className="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center lg:justify-between">

                    {/* ---------- TESTIMONIAL ---------- */}
                    <div className="lg:col-span-5 lg:col-start-1 cursor-pointer">
                        <div className="testimonial max-w-full ml-[1.2rem]">
                            <div className="mb-8">
                            ...
                            <blockquote className="relative">
                                ...
                                <div className="relative z-10">
                                    <p className="text-xl italic text-gray-800 dark:text-white">
                                        Amazing people to work with. Very fast and professional service.
                                    </p>
                                </div>
