...
const Home = () => {
    ...
    return (
        <>
            {/* ----------- HOME BANNER -----------*/}
            <section className='home_banner pt-[4rem]'>
            ...
            <section className='container mx-auto py-10 px-2.5 sm:px-0'>
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
                    <div className="h-56 sm:h-60 shadow-lg flex justify-start items-center rounded-lg bg-[#FFC522]">
                    ...
                    <div className="h-56 sm:h-60 shadow-lg flex justify-start items-center rounded-lg bg-gray-200">
                        <div className="data px-10">
