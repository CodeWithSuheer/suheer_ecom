...
const UpperShowCase = () => {
    ...
    return (
        <>
            <section className='container mx-auto py-10 px-3 sm:px-0'>
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
                    <div onClick={() => handleSingleProduct()} className="cursor-pointer overflow-hidden rounded-lg shadow-lg transition hover:shadow-lg">
                        <img
                            alt=""
                        ...
                        <div className="bg-white p-4 sm:p-4">
                            <h3 className="mt-0.5 text-lg font-semibold text-gray-900">Formal Shirt</h3>
                            <p className="mt-0.5 text-md text-gray-900">#Kids</p>
                            ...
                            <div class="flex justify-between items-center">
                                <p className="mt-2 text-black">Rs. 3000</p>
